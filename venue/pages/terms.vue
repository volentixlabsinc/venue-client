<template>
  <div class="content p-lg">
    ...
    <h3>1.5 – Necessary Equipment and Software. </h3>
    ...
    <h2>4.Third-Party Properties</h2>
    ...
    <p>Upon termination of any Service, your right to use such Service will automatically terminate immediately. VOLENTIX LABS INC will not have any liability whatsoever to you for any suspension or termination. All provisions of the Terms which by their nature should survive termination of Services will do so, including Sections 2, 5, 6.4, 7 and 8.</p>
    ...
    <h3>8.3 – Electronic Communications</h3>
    ...
    <h3>8.4 – Questions, Complaints, Claims</h3>

    <p>If you have any questions, complaints or claims with respect to the Site, Services or Software, please contact us at: <a href="mailto:support@volentixlabs.com">support@volentixlabs.com</a>.</p>
    ...
    <h3>8.10 – Governing Law and jurisdiction</h3>
    ...
    <p>Version 1.0 updated on August 25, 2018</p>
