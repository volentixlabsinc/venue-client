module.exports = {
  ...
  auth: {
    ...
    msg_policies:
      "By signing up, you agree to the Volentix <a href='{0}' target='_blank'>privacy policy</a> and <a href='{1}' target='_blank'>terms of use</a> and will be added to the Volentix newsletter.",
    msg_email: "You also agree to be added to the Volentix newsletter.",
    ...
    no_china_or_us_header: "NO CHINA OR U.S. PERSONS",
    no_china_or_us_1:
  ...
  bct_onboarding: {
    ...
    err_min_forum_level:
      "You must have a Bitcoin Talk rank of Member or better to join this campaign",
    err_profile_not_found: "Profile not found.",
    err_profile_check_user_id:
      "Please verify that you copied the correct userid",
    err_error_is_received: "HTTP {code} received",
    help_signature_1:
  ...
  titles: {
    ...
    vtx_earned: "VTX earned",
    bitcointalk_signature_campaign: "Bitcointalk Signature Campaign"
  },
  edit_signature: {
