<template>
  <div class="m-lg">
    ...
    <div class="columns">
      ...
      <div class="column">
        <CampaignButton :image="require('@/assets/socialMedia-youtube-blog.png')" :name="$t('campaigns.title_youtube')" :info="$t('campaigns.youtube')" :new-tab="false" link="/YoutubeBountyCampaign" highlight="#fc0514"/>
      </div>
      <div class="column">
